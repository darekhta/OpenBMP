...
pub use document::{
    ...
    FcTrajectoryConfigKind, FcTrajectoryKind, FcTrajectoryWaypointConfig,
    FeedModeConfig, ForcePhaseOverrideConfig, ForcesConfig, FramesConfig, FreefallRestoringConfig,
    GrainGeometryConfig, GrainPropellantConfig, InitialSloshConfig, LATEST_SCENARIO_VERSION,
    LandingFootprintConfig, LandingFootprintDispersionConfig, LandingFootprintMethod,
