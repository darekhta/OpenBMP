...
pub use document::{
    ...
    FcPhaseAuthorityConfig, FcRateLoopKind, FcTrajectoryConfig, FcTrajectoryConfigKind,
    FcTrajectoryKind, FcTrajectoryWaypointConfig, FeedModeConfig, ForcePhaseOverrideConfig,
    ForcesConfig, FramesConfig, FreefallRestoringConfig, GrainGeometryConfig,
    GrainPropellantConfig, InitialSloshConfig, LATEST_SCENARIO_VERSION, LandingFootprintConfig,
    LandingFootprintDispersionConfig, LandingFootprintMethod,
    LandingFootprintMonteCarloBallisticCoefficientConfig,
