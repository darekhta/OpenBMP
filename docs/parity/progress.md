...
As of this snapshot: **18 implemented · 17 partial · 0 in progress ·
172 not started.**
...
| 14 | Contact, touchdown, landing | WP-14.1 crate + runner force/diagnostic path present; WP-14.2 scalar primitives landed at crate level | 0/2/10 | finish WP-14.1/WP-14.2 evidence, then WP-14.3 |
