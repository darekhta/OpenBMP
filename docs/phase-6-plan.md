...
| 6.2 — Tannehill 5-species equilibrium air | deferred | `openbmp_physics::TannehillEquilibriumAir` now fails closed pending verified public table values. `AirComposition` can represent and validate the reserved 11-species ion/electron surface, but Mugalev remains reserved. |
...
- **Park 2T reaction rates.** NASA/TP-20230015593
  ...
  source model remains fail-closed.
